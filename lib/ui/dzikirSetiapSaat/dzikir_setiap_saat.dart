import 'package:adzk_dikr_app/theme.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              ItemMenu(
                jumlah: '33 X', arab: ' سبحان الله' , latin: 'Subhanallah',),
              SizedBox(height: 18,),
              ItemMenu(
                jumlah: '33 X', arab: ' الحمد لله' , latin: 'Alhamdulillah',),
              SizedBox(height: 18,),
              ItemMenu(
                jumlah: '33 X', arab: 'الله أكبره' , latin: 'Allahu Akbar',),
              SizedBox(height: 18,),
              ItemMenu(
                jumlah: '33 X', arab: ' أَسْتَغْفِرُ الله' , latin: 'Astagfirulla',),
              SizedBox(height: 18,),
